                    ...
                    <ul class="metismenu mb-4" id="menu">
                        ...
                        <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                <li><a href="./app-profile.html">Daftar Produk</a></li>
                                <li><a href="javascript:void()">Tambah Stok</a>
                                </li>
                        ...
                        <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                <li><a href="./app-profile.html">Daftar Pengguna</a></li>
                                <li><a href="javascript:void()" aria-expanded="false">Pengguna Baru</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
            ...
            <div class="footer">
                <div class="copyright">
                    <p>Copyright © Designed &amp; Developed by <a href="#"
                            target="_blank">Naufal Amajid</a> {{ date('Y') }}</p>
                </div>
            </div>
            <!--**********************************
            Footer end
